...
import { setPaymentAmount } from "@/redux/slices/paymentSlice";
import { fetchPatientAppointments } from "@/redux/slices/userAppointmentsSlice";
...
const FormSummary = ({ inputData, doctors = [] }) => {
  ...
  useEffect(() => {
    if (success) {
      ...
      dispatch(setPaymentAmount(consultationFee + labServiceFee));
      // Refresh the patient's appointments list so the newly booked appointment appears
