...
import { User, Bell, LogOut, Loader, Check, UserPen } from "lucide-react";
import {
	DropdownMenu,
	DropdownMenuContent,
	DropdownMenuItem,
...
export default function NavBar() {
	...
	const handleNotificationClick = (notificationId, isRead) => {
		if (!isRead) {
			dispatch(markNotificationAsRead(notificationId)).catch(error => {
	...
	const handleMarkAllAsRead = () => {
		dispatch(markAllNotificationsAsRead()).catch(error => {
	...
	return (
		<>
			<div className="grid grid-cols-4 items-center h-40 lg:h-24">
				<div className="flex justify-center col-span-4 lg:col-span-1 ">
					<img src="/Healthcare-Logo.svg" alt="Healthcare-logo" />
				</div>
				<div className="col-span-4 md:col-span-4 lg:col-span-2   flex justify-evenly text-lg font-medium ">
					<div className="text-[#007E85]">
						<NavLink to="/patient-home">Home</NavLink>
					</div>
					<div>
						<a href="/patient-home#service">Service</a>
					</div>
					<div>
				...
				{!isAuthenticated ? (
					<div className="flex gap-3 justify-center col-span-4 lg:col-span-1 ">
					...
					<div className="flex gap-6 justify-center items-center col-span-4 lg:col-span-1 ">
							...
							>
								<DropdownMenuLabel className="flex justify-between items-center">
									...
									{unreadCount > 0 && !notificationsLoading && (
										<button
											...
											className="text-xs text-[#007E85] hover:text-[#005f68] font-semibold disabled:opacity-50"
								...
								{notificationsError && (
									<div className="p-4 bg-red-50 border border-red-200 rounded">
										<p className="text-xs text-red-600 font-medium">Error: {notificationsError}</p>
									</div>
								)}
						...
						<DropdownMenu>
							...
							<DropdownMenuContent align="end">
								...
								<DropdownMenuItem
									...
									className="text-blue-600 focus:bg-blue-50 focus:text-blue-600 cursor-pointer"
								>
