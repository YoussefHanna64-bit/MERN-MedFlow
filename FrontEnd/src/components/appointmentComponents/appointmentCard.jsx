...
const AppointmentCard = ({ appointment, isLast }) => {
	...
	return (
		<div
			className={`grid grid-cols-[2fr_1fr_2fr_1fr_1fr] bg-[#f2f4f5]/60 p-4 ${isLast ? "rounded-b-xl" : ""}`}
		>
			...
			{appointment.status === "cancelled" ? (
				...
				<div className="flex gap-2 justify-center">
					<div className="relative group">
						...
						<span className="absolute -top-8 left-1/2 -translate-x-1/2 whitespace-nowrap rounded bg-gray-800 px-2 py-1 text-xs text-white opacity-0 group-hover:opacity-100 transition-opacity duration-200">
							Cancel Appointment
						</span>
					</div>
					<div className="relative group">
